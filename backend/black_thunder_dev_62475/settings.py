"""
Django settings for black_thunder_dev_62475 project.
...
ROOT_URLCONF = 'black_thunder_dev_62475.urls'
...
WSGI_APPLICATION = 'black_thunder_dev_62475.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_thunder_dev_62475 API",
    "DESCRIPTION": "API documentation for black_thunder_dev_62475 App",
    "VERSION": "v1",
}
